...
>(object: Input, properties: Property[]): Omit<Input, Property> => {
...
type ExcludeFrontendMessageProperties = Exclude<keyof MaybeFrontendMessagePartial, keyof MessageBody>;
...
export const changeFrontendMessageToMessageBody = (message: MaybeFrontendMessagePartial): MessageBody => {
  return deletePropertiesFrom<MaybeFrontendMessagePartial, ExcludeFrontendMessageProperties>(message, excludeFrontendMessageProperties);
}